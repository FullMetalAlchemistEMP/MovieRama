...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for i in range(1, 21):
            username = f"user{i}"
            user, created = User.objects.get_or_create(username=username, defaults={"email": f"{username}@demo.com"})
        ...
        movies_data = [
            ...
            ("Interstellar", "A team of explorers travel through a wormhole to ensure humanity's survival."),
            ...
            ("The Fifth Element", "A cab driver in the future becomes central to saving the world."),
            ...
            ("Doctor Strange", "A surgeon turns sorcerer to protect the world from mystical threats."),
            ("Edge of Tomorrow", "A soldier relives the same day in a war against aliens."),
            ("The Hunger Games", "A girl fights for survival in a dystopian televised death match."),
